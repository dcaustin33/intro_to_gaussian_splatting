...
class GaussianModel:
    ...
    def create_from_pcd(self, pcd: BasicPointCloud, spatial_lr_scale: float):
        ...
        dist2 = torch.ones((fused_point_cloud.shape[0], 3), device="cpu")
        # import pdb; pdb.set_trace()
        scales = torch.ones((fused_point_cloud.shape[0], 3), device="cpu")
        ...
        opacities = inverse_sigmoid(
            0.1
            * torch.ones(
                (fused_point_cloud.shape[0], 1), dtype=torch.float, device="cpu"
            )
        )
